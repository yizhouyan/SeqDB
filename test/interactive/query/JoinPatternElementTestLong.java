 ...
 */
class JoinPatternElementTestLong {
...
//        storage.printSequenceStorage();
    ...
    @Test
    void joinPatternElementTest_frontFreqBackEle_twoContainer(){
        setUp_1();
...
//        storage.printSequenceStorage();
    ...
    @Test
    void joinPatternElementTest_frontFreqBackEle_twoContainer_gap(){
        setUp_10();
        short [] oneSeq = {1,2,3,4};
        FPQuery query = new FPQuery(storage, oneSeq);
...
//        storage.printSequenceStorage();
    ...
    @Test
    void joinPatternElementTest_frontFreqBackEle_twoContainer_hasnextStart(){
        setUp_3();
        short [] oneSeq = {1,2,4};
        FPQuery query = new FPQuery(storage, oneSeq);
...
//        storage.printSequenceStorage();
    ...
    @Test
    void joinPatternElementTest_frontFreqBackEle_oneContainer(){
        setUp_2();
        short [] oneSeq = {1,2,4};
        FPQuery query = new FPQuery(storage, oneSeq);
...
//        storage.printSequenceStorage();
    ...
    @Test
    void joinPatternElementTest_frontFreqBackEle_twoContainer_hasnextStart_2(){
        setUp_4();
        short [] oneSeq = {1,2,4};
        FPQuery query = new FPQuery(storage, oneSeq);
...
//        storage.printSequenceStorage();
    ...
    @Test
    void joinPatternElementTest_frontEleBackFreq_OneContainer(){
        setUp_5();
...
//        storage.printSequenceStorage();
    ...
    @Test
    void joinPatternElementTest_frontEleBackFreq_twoContainers(){
        setUp_6();
        short [] oneSeq = {5,1,2,3};
        FPQuery query = new FPQuery(storage, oneSeq);
...
//        storage.printSequenceStorage();
    ...
    @Test
    void joinPatternElementTest_frontEleBackFreq_twoContainers_2(){
        setUp_7();
        short [] oneSeq = {5,1,2,3};
        FPQuery query = new FPQuery(storage, oneSeq);
...
//        storage.printSequenceStorage();
    ...
    @Test
    void joinPatternElementTest_frontEleBackFreq_twoContainers_3(){
        setUp_8();
        short [] oneSeq = {5,1,2,3};
        FPQuery query = new FPQuery(storage, oneSeq);
...
//        storage.printSequenceStorage();
    ...
    @Test
    void joinPatternElementTest_frontEleBackFreq_mix(){
        setUp_mix();
