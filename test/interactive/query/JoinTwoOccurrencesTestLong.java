 ...
 */
class JoinTwoOccurrencesTestLong {
...
//        storage.printSequenceStorage();
    ...
    @Test
    void queryOnSingleSequenceTest_JoinTwoMatch_backNext(){
        setUp_1();
...
//        storage.printSequenceStorage();
    ...
    @Test
    void queryOnSingleSequenceTest_JoinTwoMatch_backNext_2(){
        setUp_2();
...
//        storage.printSequenceStorage();
    ...
    @Test
    void queryOnSingleSequenceTest_JoinTwoMatch_frontNext(){
        setUp_6();
        short [] curQuery = {1,2,3,4,5};
        FPQuery query = new FPQuery(storage, curQuery);
