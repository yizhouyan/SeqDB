...
import interactive.mining.baseline.maximum.ItemPair;
import interactive.mining.baseline.maximum.ResItemArrayPair;
import interactive.mining.baseline.maximum.Sequence;
...
public class PrefixSpanToolClose {
	...
	public PrefixSpanToolClose(InputSequenceWithTS inputSequence, LocalParameterSpaceWithTS localParameterSpace) {
