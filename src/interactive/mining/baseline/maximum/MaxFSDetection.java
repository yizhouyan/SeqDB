package interactive.mining.baseline.maximum;
...
public class MaxFSDetection {
	private LocalParameterSpaceWithTS localParameterSpace;
	private ArrayList<String> inputStringArray;

	public MaxFSDetection(int minSupportLocal, int itemGap, int seqGap, long itemInterval, long sequenceInterval,
...
//		String inputPath = "../data/realdata/logstream.csv";
		...
		MaxFSDetection globalFS = new MaxFSDetection(LocalMinSupport, itemgap, seqGap, itemInterval, seqInterval,
				inputStringArray);
