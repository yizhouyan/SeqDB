...
import interactive.mining.baseline.top.core.lts.local.datamodel.HashMapSet;
...
import interactive.mining.baseline.top.utils.generateCombine;
...
public class SingleSequenceBase implements Comparable {
    ...
    /**
     * If we have ABABABAB, we just want to count 2 ABAB
     * @param newStr
     * @param newIndexes
     * @param usedIndexBySubs
     * @return
     */
